package ru.mirea.lavrukhin.multiactivity;
...
import ru.mirea.lavrukhin.multiactivity.databinding.ActivitySecondBinding;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMirea = findViewById(R.id.textViewSent);
        tvMirea.setText(value);
